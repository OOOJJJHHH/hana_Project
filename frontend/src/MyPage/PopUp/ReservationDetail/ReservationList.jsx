            ...
            {pendingReservations.map((reservation) => (
                <div key={reservation.reservationId} style={styles.reservationCard}>
                    <div style={styles.cardInfo}>
                        <p>
                            <strong>예약 번호:</strong> {reservation.reservationCode}
                        </p>
                        <p>
                            <strong>예약자 ID:</strong> {reservation.userId}
                        </p>
                        <p>
                            <strong>숙소명:</strong> {reservation.clodName}
                        </p>
                        <p>
                            <strong>객실명:</strong> {reservation.roomName}
                        </p>
                        <p>
                            <strong>체크인:</strong>{" "}
                        ...
                        <p>
                            <strong>요청사항:</strong> {reservation.memo || "없음"}
                        </p>
                    </div>
